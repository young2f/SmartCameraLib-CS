    ...
    public class HKCapturerBase64 : HKBase64
    {
        ...
        public override LoginResult LoginSuccess(CameraEntity entity, LoginResult result)
        {
            ...
            if (!(m_LoginID < 0))
            {
                ...
                HKCHCNetSDK64.NET_DVR_JPEGPARA lpJpegPara = new HKCHCNetSDK64.NET_DVR_JPEGPARA();
                ...
                if (!HKCHCNetSDK64.NET_DVR_CaptureJPEGPicture(m_LoginID, lChannel, ref lpJpegPara, sJpegPicFileName))
                {
                    string str = "NET_DVR_CaptureJPEGPicture failed, error code= " + HKCHCNetSDK64.NET_DVR_GetLastError();
        ...
        public void LogoutAll()
        {
            ...
            try
            {
                foreach (var v in loginData)
                {
                    ...
                    if (v.Value >= 0)
                    {
                        if (!HKCHCNetSDK64.NET_DVR_Logout(v.Value))
                        {
