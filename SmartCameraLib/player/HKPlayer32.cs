...
{
    public class HKPlayer32 : HKBase32, ICameraPlay
    {
        private static object instanceLock = new object();
        private static HKPlayer32 INSTANCE;
        public static HKPlayer32 GetInstance()
        {
            lock (instanceLock)
            {
                if (INSTANCE == null)
        ...
        public override LoginResult LoginSuccess(CameraEntity camera, LoginResult result)
        {
            ...
            HKCHCNetSDK32.NET_DVR_PREVIEWINFO lpPreviewInfo = new HKCHCNetSDK32.NET_DVR_PREVIEWINFO();
            ...
            Int32 playId = HKCHCNetSDK32.NET_DVR_RealPlay_V40(result.loginId.ToInt32(), ref lpPreviewInfo, null/*RealData*/, pUser);
            if (playId < 0)
            {
                result.message = "播放失败:" + HKCHCNetSDK32.NET_DVR_GetLastError();
                return result;
            }
            result.isOk = true;
            result.message = "ok";
